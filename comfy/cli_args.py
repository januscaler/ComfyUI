...
parser.add_argument("--auto-download-models", action="store_true", help="Automatically download missing models defined in model_download_urls.yaml when a workflow references them.")
